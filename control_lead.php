                  ...
                  <div class="card-body">
                    ...
                    <div class="table-outer">
                      <div class="table-responsive">
                        <table class="table table-striped align-middle m-0" id="tabla_leads">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Fecha</th>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="newLeadModalLabel">Nuevo Lead</h5>
                    ...
                    <form id="newLeadForm">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="id_asesor" name="id_asesor" required>
                            <option value="">Seleccione un asesor</option>
                            <!-- Options will be populated dynamically based on plaza selection -->
                          </select>
                        </div>
                      </div>
                      <div class="mb-3">
